        ...
        <div>
            ...
            <div class="list">
              <div class="listTop">
                ...
                <div v-show="dataList.appealStatus == '2'">
                  <div>未通过原因：</div>
                  <div>{{dataList.appealReason | strFun}}</div>
                </div>
              </div>
              <div class="listContent">
                <div class="listItemTitle" v-show="dataList.appealStatus == '2'">
                  <div>
                    <div>新手机号：</div>
                    <div>{{dataList.newPhone | strFun}}</div>
                  </div>
                  <div>
                    <div>原手机号：</div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["getClientAppealgetAppealById"])
  },
  watch: {
...
.listItemTitle > div > div:nth-child(1) {
  font-size: 14px;
}
</style>
