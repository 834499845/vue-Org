...
export default {
  ...
  methods: {
    ...
    bigBackClick() {
      ...
      self.isShowBig = false;
      self.bigShow = true;
      self.bigImgUrl = self.self.dataList.cardLeftImg
      // console.log(self.bigImgUrl);
    },
    // 查看手持身份证大图
    bigHandleClick() {
      var self = this;
    ...
    passClick() {
      ...
      if (self.passClickTrueOrFalse == true) {
         ...
         self.getClientSideIdentityAuditAudit({
          id: sessionStorage.getItem("id"),
          state: '1',
        }).then(data => {
    ...
    ...mapActions(["getClientSideIdentityAuditGetApplyData","getClientSideIdentityAuditAudit","getClientSideIdentityAuditGetRejectReasonList"])
  },
  watch: {
