    ...
    <div id="app" class="sale">
        <div>
            <div class="listTitle">
                <div>
                    <div @click="backClick">
                        <img src="/static/img/fan.png" alt="返回" title="返回">
                    </div>
                    <div>
                        编辑勋章
                    </div>
                ...
                <div class="listContent">
                    ...
                    <div class="listMedelImg">
                        ...
                        <div>
                            ...
                            <div>
                                <label class="grayIconlabel" for="listMedelTwoImg">上传</label>
                            </div>
                        </div>
                        <div :class="{redTest:isRedListMedelTwoImg,grayTest:isGrayListMedelTwoImg}">
                            支持尺寸：225*225像素（灰色小图）
                        </div>
                        <div>
                            <input id="listMedelTwoImg" type="file" accept="image/jpeg,image/jpg,image/png" @change="onimageTwoListMedelChange">
                        </div>
                    </div>
                    <div class="button">
                        <div @click="ucompileClick">确定</div>
...
export default {
  ...
  data() {
    return {
      ...
      isRedListMedelTwoImg: false,
      isGrayListMedelTwoImg: true,
      isbgOneImg: false,
      isbgTwoImg: false,
  ...
  created: function() {
    ...
    if (userRoleOBj) {
      ...
      if (arrs.indexOf("medel") == -1) {
        ...
        self.idVal = sessionStorage.getItem("idVal")
        self.indexNumber = sessionStorage.getItem("medelIndex")
        self.nameVal = sessionStorage.getItem("nameVal")
        self.scoreVal = sessionStorage.getItem("scoreVal")
        self.imageOneDetailMedel = sessionStorage.getItem("detailBrightImage")
        self.imageOneListMedel = sessionStorage.getItem("itemBrightImage")
        self.imageTwoDetailMedel = sessionStorage.getItem("detailGrayImage")
        self.imageTwoListMedel = sessionStorage.getItem("itemGrayImage")
        console.log(self.imageTwoDetailMedel)
        console.log(self.imageOneDetailMedel)
      }
    } else {
  ...
  methods: {
          ...
          reader.onload = function(e) {
            ...
            image.onload = function() {
               if (fileData.size == 102400) {
                ...
                document.getElementById("listMedelTwoImg").value = "";
                return 
              } else if (image.width !== 225) {
                self.$message({
                  type: "info",
    ...
    backClick() {
      ...
      sessionStorage.removeItem("medelIndex")
      sessionStorage.removeItem("nameVal")
      sessionStorage.removeItem("scoreVal")
      sessionStorage.removeItem("detailBrightImage")
      sessionStorage.removeItem("detailGrayImage")
      sessionStorage.removeItem("itemBrightImage")
      sessionStorage.removeItem("itemGrayImage")
    },
    ...mapActions([
