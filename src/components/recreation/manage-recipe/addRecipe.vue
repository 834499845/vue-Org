  ...
  <div id="app" class="sale">
    ...
    <div class="dietContent">
      ...
      <div class="handle">
        ...
        <div class="abolish" @click="backList">取消</div>
      </div>
    </div>
    <!--提示信息弹出框-->
...
export default {
  ...
  methods: {
    ...
    addfoodSave() {
      ...
      if (this.tt.length !== 0 && this.selected.length == 0) {
        this.$message({
          message: "请选择食物一重量！"
        });
        return;
      }
      if (this.tt1.length == 0 && this.selected1.length !== 0) {
        this.$message({
          message: "请选择食物二！"
        });
        return;
      ...
      if (this.tt2.length == 0 && this.selected2.length !== 0) {
        this.$message({
          message: "请选择食物三！"
        });
        return;
      ...
      if (this.tt3.length == 0 && this.selected3.length !== 0) {
        this.$message({
          message: "请选择食物四！"
        });
        return;
          ...
          .then(data => {
            if (data.code == 200) {
              if (self.selectedTime == 1) {
                if (s > data.data.BREAKFAST_CALORIES) {
                  this.$message({
                    message: "千卡过高，请选择重新搭配食物！"
                  });
                }
                return;
              }
              if (self.selectedTime == 2) {
                if (s > data.data.LUNCH_CALORIES) {
                  this.$message({
                    message: "千卡过高，请选择重新搭配食物！"
                  });
                }
              ...
              if (self.selectedTime == 3) {
                if (s > data.data.DINNER_CALORIES) {
                  this.$message({
                    message: "千卡过高，请选择重新搭配食物！"
                  });
                }
              ...
              if (self.selectedTime == 4) {
                if (s > data.data.ADDMEAL_CALORIES) {
                  this.$message({
                    message: "千卡过高，请选择重新搭配食物！"
                  });
                }
