                ...
                <div class="listCont">
                    <div class="listImg">
                        <ul>
                            ...
                            <li class="addLiImg" v-show="lists.length != 20" @click="addImgClick">
                                <div>
...
export default {
  ...
  methods: {
    ...
    aupsortClick() {
      var self = this;
      if (self.aupsortClickTrue == false) {
        var type = "";
        var arrs = [];
        var idJson = "";
        var ids = [];
